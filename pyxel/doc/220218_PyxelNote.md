...
しかし，エミュレータ開発から20年位は，色々と忙しくてできなかったのですが，2020年頃のコロナ禍の時に，再度ビデオゲームの復刻に手を出すことになります．
...
Octo記法で復刻したアセンブリ言語のソースを，Pyxelに移植できたら，キャラクタを豪華にしたりして，面白いゲームになるかもしれない，
とか考えるようになりました．
...
数百行のアセンブラで書いたゲームを，Grok君でPythonに変換した話も，
[ボトムカンファレンス](https://x.com/utshina2/status/1981657034576863697)なら通るかもしないです．

### 2025-11-27

今年は生成AIを使って，Chip8のコードをPyxelコードに変換して遊びました．色を塗ったりして，レトロゲームっぽく仕上げてみました．
JavaScriptの実装は容易にPyxel化できます．プログラム変換が容易になることを考えると，ゲームの進化樹で絶滅した実装を容易に復刻できるかもしれません．
とは言え，その領域は，無論技術的には模擬器で占められているわけですが，絶滅したビデオゲームをさらに進化させるには、生成AIの力を借りるのがいいでしょう．
Chip8からPyxelへの例では，単に色を塗っているだけですが，キャラクタやサウンドを変更してしまえば，世界観を変えることもできるでしょう．
